    ...
    <section v-else class="my-8">
      ...
      <div class="flex flex-col gap-4">
        <ULink 
          ...
          class="experiment-card bg-white dark:bg-gray-900 
            py-4 px-6 rounded-lg border border-gray-200 dark:border-gray-800
            hover:shadow-sm hover:border-gray-300 dark:hover:border-gray-700 transition-all duration-300"
        >
          <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200 mb-2">{{ experiment.name }}</h3>
          <p class="text-gray-600 dark:text-gray-400 text-size-3">{{ experiment.description }}</p>
