...
class Post {
  ...
  /// True if this post has been released somewhere.
  final bool released;

  /// This post's cover to show on large widget component (eg. a post).
  final Cover cover;

  /// The date when this post was updated as an Firestore document.
  final DateTime updatedAt;

  /// The date when this post was created as a Firestore document.
  final DateTime createdAt;

  /// The date when this post was released.
  final DateTime releasedAt;

  /// Whetheir this post is public or private.
  final EnumContentVisibility visibility;

  /// Amount of characters in this post's post content.
  final int characterCount;

  /// Post's size.
  final int size;

  /// Amount of words in this post's post content.
  final int wordCount;

  /// Where this post can run (eg. Web, Android).
  final List<String> platforms;

  /// Languages this post has been made with (eg. "C#").
  final List<String> programmingLanguages;

  /// This post's tags to categorize (eg. "weather", "quotes").
  final List<String> tags;

  /// This post's unique identifier.
  final String id;

  /// In which human language the post metadata is written with (eg. english).
  ...
  /// Where we can find this post on the internet (eg. dribbble, instagram).
  final SocialLinks socialLinks;

  /// Estimated time to read this post's post/information.
  ...
  /// This post's thumbnails to show on small widget component (eg. cards).
  ...
  @override
  String toString() {
    return "Post(createdAt: $createdAt, id: $id, "
