...
import 'package:rootasjey/types/user/profile_picture.dart';
import 'package:rootasjey/types/user/user_rights.dart';
import 'package:rootasjey/types/user/user_stats.dart';
...
class UserFirestore {
  ...
  /// Various metrics on this user's projects, posts, etc.
